...
players = Player.create([
  ...
  {screen_name: "SUDO", first_name: "Superuser", last_name:"Jones", email: "sudo@ga.co", commissioner_attributes: {password_digest: "$2a$10$mxfRycIPBHtC.REGcKOq5ONhxHiGJMzMOYxxleAfDA6cOBGChrOHC", designer:true}},
])
